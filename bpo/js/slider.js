...
function initSliders() {
	...
	if (document.querySelector(".recognitions__slider")) new Swiper(".recognitions__slider", {
		...
		loop: true,
		navigation: {
			prevEl: ".recognitions__button--prev",
			nextEl: ".recognitions__button--next"
		},
		breakpoints: {
			320: { slidesPerView: 1 },
			992: { slidesPerView: 2 },
	...
	if (document.querySelector(".team-career__slider")) new Swiper(".team-career__slider", {
		modules: [Navigation, Autoplay],
		observer: true,
		observeParents: true,
		slidesPerView: 4,
		...
		loop: true,
		navigation: {
			prevEl: ".team-career__button--prev",
			nextEl: ".team-career__button--next"
		},
		breakpoints: {
			320: { slidesPerView: 1 },
			992: { slidesPerView: 2 },
