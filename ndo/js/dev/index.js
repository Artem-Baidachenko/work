...
const searchBlockMob = document.querySelector(".block-search");
const searchInputMob = document.querySelector(".search-header__input");
...
searchInputMob.addEventListener("input", () => {
  if (searchInputMob.value.trim().length > 0) {
    searchBlockMob.style.opacity = "1";
    searchBlockMob.style.pointerEvents = "auto";
  } else {
    searchBlock.style.opacity = "0";
    searchBlock.style.pointerEvents = "none";
  }
